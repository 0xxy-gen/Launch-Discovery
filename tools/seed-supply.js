...
const PROVIDERS = {
  ...
  ArianeGroup:                { email: 'arianegroup@demo.aether', country: 'France', heritage: '10+' },
  'JAXA / MHI':               { email: 'mhi@demo.aether', country: 'Japan', heritage: '10+' },
...
const LAUNCHES = [
  ...
  { seller: 'ArianeGroup', name: 'Vega-C SSMS POC-6', vehicle: 'Vega-C',
  ...
  { seller: 'ArianeGroup', name: 'Ariane 6 — GTO shared', vehicle: 'Ariane 6',
    site: 'Kourou ELA-4', orbit: 'gto', alt: 35786, inc: 6, when: '2028-04', cap: 4500, done: 2600 },
  { seller: 'JAXA / MHI', name: 'H3 — GTO co-manifest', vehicle: 'H3',
