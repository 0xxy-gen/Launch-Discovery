...
export function validateRegistration(body = {}) {
  ...
  return { fields, values: { email, password, accountType, name, role } };
}
...
export function validateProfile(body = {}) {
  ...
  if (!name) fields.name = 'Your name is required.';
  else if (name.length > 120) fields.name = 'That name is too long.';
  ...
  return { fields, values: { organisation, name, role, country, linkedin, dial, phone } };
}
